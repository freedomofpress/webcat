...
WEBCAT is:
 ...
 5. Some dependencies, such as [sigsum-ts](https://github.com/freedomofpress/sigsum-ts), [cometbft-ts] and [sigstore-browser](https://github.com/freedomofpress/sigstore-browser).
